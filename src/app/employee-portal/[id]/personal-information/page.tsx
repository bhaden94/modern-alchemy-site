...
import AdminPersonalInformationControls from '~/components/AdminControls/AdminPersonalInformationControls'
...
const PersonalInformationSettingsPage = async ({
  params,
}: {
  params: { id: string }
}) => {
  ...
  return (
    <PageContainer>
      <PageTitle title={`${artist.name} Personal Information Settings`} />
      <AdminPersonalInformationControls artist={artist} />
    </PageContainer>
  )
}
