...
setup('authenticate with Vercel and Google', async ({ page }) => {
  ...
  await page.goto('https://modern-alchemy-site-git-preview-brady-hadens-projects.vercel.app');
  ...
  await page.waitForURL(/modern-alchemy-site-git-preview.*/, { timeout: 300000 });
  ...
  if (currentUrl.includes('accounts.google.com') || currentUrl.includes('unauthorized')) {
